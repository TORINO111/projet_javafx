...
public class RoleRepositoryJdbcPostgreImpl extends RepositoryDbPostgreImpl<Role> implements RoleRepository {
    ...
    private static final String SELECT_QUERY = "SELECT roles.nom AS role_nom, roles.id AS role_id, roles.created_at AS role_created_at, roles.updated_at AS role_updated_at FROM roles";
