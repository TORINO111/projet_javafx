...
public class ListeDemandesDettesClientController extends ClientController {
    ...
    public void initialize() {
        ...
        try {
            ...
            // Dettes du client
            listDettesClient = detteService.listeDettesEnAttenteDeValidation(client);
                ...
                protected void updateItem(String item, boolean empty) {
                    ...
                    if (empty) {
                        ...
                        button.setOnMouseClicked(event -> {
                            ...
                            System.out.println("Bouton Détails cliqué pour la dette ID: " + selectedDette.getId());
    ...
    private void showDetails(Dette dette) {
        ...
        // Logique pour afficher les détails de la dette
        System.out.println("Afficher les détails pour la dette ID: " + dette.getId());
    }
